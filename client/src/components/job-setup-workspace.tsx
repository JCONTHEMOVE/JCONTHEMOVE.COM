...
export type JobSetupSection = "customer" | "details" | "schedule" | "quote" | "";

interface JobSetupWorkspaceProps {
  activeSection: JobSetupSection;
  onSectionChange: (section: JobSetupSection) => void;
  lead: JobSetupLead;
      ...
      <CardContent className="px-4 pb-3 [&_input]:min-h-11 [&_input]:text-base [&_textarea]:text-base [&_button[role=combobox]]:min-h-11 [&_button[role=combobox]]:text-base">
        ...
        <AccordionItem value="customer">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {lead.phone && <Button asChild variant="outline"><a href={`tel:${lead.phone}`}>Call</a></Button>}
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <p className="flex items-center gap-1 text-sm font-semibold text-emerald-300">
                      {quotePricingSource === "manual_override" ? "Saved manual quote" : quoteIsUpdating ? "Updating automatic quote..." : quoteDirty ? "Unsaved estimate" : "Saved automatic quote"}

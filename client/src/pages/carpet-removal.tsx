        ...
        {saved ? <div role="status" className="rounded-xl border border-emerald-200 bg-white p-7 shadow-sm">
          ...
          <form className="mt-7 space-y-6" onSubmit={submit}>
            ...
            <div className="flex flex-wrap gap-5">
              <label className="flex min-h-11 cursor-pointer items-center gap-3"><input type="checkbox" className="h-5 w-5 accent-emerald-800" checked={haulAway} onChange={event => setHaulAway(event.target.checked)} />Haul away removed material</label>
              <label className="flex min-h-11 cursor-pointer items-center gap-3"><input type="checkbox" className="h-5 w-5 accent-emerald-800" checked={furnitureHelp} onChange={event => setFurnitureHelp(event.target.checked)} />Help moving furniture</label>
            </div>

...
- The queue/worker harness now also runs in a dedicated PostgreSQL CI step. Its first execution at `637ea010`, run 34388707086, is pending. Later commits are not validated by earlier green CI.
